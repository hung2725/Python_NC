...
# Tạo style riêng cho mighty
style = ttk.Style()
style.configure("Mighty.TLabelframe.Label", foreground="Blue")  # chữ tiêu đề màu xanh

# We are creating a container frame to hold all other widgets
mighty = ttk.LabelFrame(win, text=' Pham The Hung ', style="Mighty.TLabelframe")
